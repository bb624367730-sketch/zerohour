...
const en: Translations = {
  ...
  'htp.rule.mechanics.1': 'This is a Sui blockchain-based FOMO game. Each round has a 24-hour countdown.',
...
const zhCN: Translations = {
  ...
  'htp.rule.mechanics.1': '这是一个基于 Sui 区块链的 FOMO 博弈游戏。每轮 24 小时倒计时。',
...
const ja: Translations = {
  ...
  'htp.rule.mechanics.1': 'これはSuiブロックチェーン上のFOMOゲームです。各ラウンドは24時間のカウントダウン。',
...
const ko: Translations = {
  ...
  'htp.rule.mechanics.1': '이것은 Sui 블록체인 기반 FOMO 게임입니다. 각 라운드는 24시간 카운트다운.',
